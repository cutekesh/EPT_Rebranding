  ...
  return (
    <div className="p-6 md:p-8 rounded-lg bg-[#E6F3EC]">
      ...
      <div className="space-y-7">
        {/* Changed to flex-col on mobile, flex-row on md+, added gap for spacing when stacked */}
        <div className="flex flex-col md:flex-row justify-between text-[#000101] gap-1">
