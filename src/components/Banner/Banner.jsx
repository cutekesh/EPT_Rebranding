  ...
  return (
    <div className="bg-[#008A3F] w-full">
      <div className="w-11/12 mx-auto container ">
        <div className="flex py-[3.91px] md:py-[80px] justify-between items-center">
          <div className="flex items-center gap-[3px] md:gap-[10.77px] md:w-auto">
          ...
          <div className="flex items-center gap-[3px] md:gap-[10.77px] 2xl:border-l-[1px] lg:border-white md:pl-10 md:w-auto ">
