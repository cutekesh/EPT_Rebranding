...
const WorkCards = () => {
  return (
    <div className="w-full flex gap-4 py-6 overflow-x-auto">
      {works.map((work) => (
        <div
          className="flex-shrink-0 w-72 sm:w-80 md:w-[293.84px] xl:w-[320px] 2xl:w-[425px] h-[350px] sm:h-[400px] md:h-[420.19px] relative bg-work rounded-md"
          key={work.id}
          style={{
        ...
        >
          <img
            className="absolute top-[45%] md:top-1/2 -right-6 z-10 w-9 md:w-auto max-h-[60%] object-contain"
            src={work.img}
            alt={work.img}
          />
