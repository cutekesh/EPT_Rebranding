  ...
  return (
    <div className="bg-[#E6F3EC]">
      ...
      <div className="w-full text-4xl font-bold px-6 md:px-0 lg:ml-8 xl:ml-0 flex flex-col gap-2 justify-center font-IBM">
        <h2 className="text-[#013F1E] md:text-[#333333]">Take <span className="text-[#007A4D]">Energy</span> to <br/>the next level</h2>
        <div className="hidden md:block w-29 border-b-2 border-b-[#007A4D]"></div>
      </div>
      </div>
    </div>
  )
