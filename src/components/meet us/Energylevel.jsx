  ...
  return (
    <div className="bg-[#E6F3EC]">
      <div className="w-11/12 mx-auto container py-6 flex flex-col-reverse md:flex-row gap-6 md:gap-10 lg:gap-16  xl:gap-[20%] justify-between">
        ...
        <h3 className="hidden md:flex text-[#000000] text-lg md:text-xl lg:text-[25px] font-bold font-Inter">Integrated Consulting, Engineering <br/>& Asset Services</h3>
      ...
      <div className="w-full text-4xl font-bold px-6 md:px-0 lg:ml-8 xl:ml-0 flex flex-col gap-2 justify-center font-IBM">
        <h2 className="text-[#333333] md:text-[#333333] text-[64px] font-IBM ">Take <span className="text-[#007A4D]">Energy</span> to <br/>the next level</h2>
        <div className="hidden md:block w-50 border-b-3 border-b-[#007A4D]"></div>
      </div>
      </div>
    </div>
  )
