...
const Login = () => {
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2">
      <div>
        <img src={Workers} alt="Workers" className="w-full h-full object-cover rounded-md" />
      </div>
      ...
      <div className="flex items-center justify-center px-4 sm:px-8 md:px-16 bg-white">
        <div className="w-full max-w-md sm:max-w-lg ">
          ...
          <div className="mb-8">
            <h1 className="text-[22px] sm:text-[26px] lg:text-[28px] font-semibold">Welcome Back</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex flex-col gap-2">
              <label htmlFor="email" className="text-[15px] sm:text-[16px] font-bold uppercase">
                Email
              </label>
              <input
                id="email"
            ...
            <div className="flex flex-col gap-2 relative">
              <label htmlFor="password" className="text-[15px] sm:text-[16px] font-bold uppercase">
                Password
              </label>
              <input
                id="password"
            ...
            <Link to="/" className="text-[14px] sm:text-[16px] font-medium text-end block">
              Forgot Password?
            </Link>
