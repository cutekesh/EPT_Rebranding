...
const ResetPassword = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      ...
      setLoading(false); // Stop loading after simulated success
    }, 1500);
  };
          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-6 text-black">
              ...
              <button
                type="submit"
                disabled={loading}
                className={`w-full bg-[#008A3F] text-white font-semibold py-2 px-4 rounded-md transition-all ${
              ...
              <p className="text-center text-sm text-[#000101] text-[16px] font-normal">
                Back to Login?{" "}
                <Link to="/login" className="text-[#008A3F] font-semibold hover:underline">
                  Login
                </Link>
              </p>
            </form>
